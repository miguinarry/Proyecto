...
// Centralita.cpp : Defines the class behaviors for the application.
//
...
// The one and only CCentralitaApp object

CCentralitaApp theApp;


// CCentralitaApp initialization
